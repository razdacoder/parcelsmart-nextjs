...
export default function AlertPopUp() {
  ...
  return (
    <AlertDialog open={isOpen} onOpenChange={onClose}>
      <AlertDialogContent className="flex flex-col items-center gap-6 w-11/12 md:max-w-lg rounded-lg">
        ...
        {type === "warning" && (
          ...
          >
            <circle cx="48" cy="48" r="48" fill="#D27C2C" fillOpacity="0.25" />
            <path
        ...
        {type === "error" && (
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <circle cx="48" cy="48" r="48" fill="#FF98B9" fillOpacity="0.4" />
            <path
